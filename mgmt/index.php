...
<!-- Header End -->
	...
	<!-- Home -->
	<div class="home" style="background-image:url(/FOE/images/slider_background.jpg);height: 100%
		 background-position: center;background-repeat: no-repeat;background-size: cover;">
		<center>
		<!-- form -->
			<form name="login"  method="post" class="login-form" action="mgmt_login_validation.php"
			style="width: 26%;right: 37%;">
		          ...
		          <div class="txtb">
		            ...
		            <br><br>
					<u><a href="/FOE/common/forgot_password.php?user=mgmt">Forgot password</a></u>...?<u><a href="/FOE/common/signup.php?signup=2">Sign Up</a></u>
		          </div>
